...
export default function AboutPage() {
  return (
    <article className="max-w-3xl mx-auto px-8 py-8">
      ...
      <p className="text-lg md:text-[1.3rem] mb-8 leading-relaxed text-gray-800 dark:text-gray-100 font-hand">
      ...
      <p className="mb-4 text-base md:text-lg text-gray-800 dark:text-gray-100 font-hand">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2 text-base md:text-lg text-gray-800 dark:text-gray-100 font-hand">
      ...
      <p className="mt-8 text-base md:text-lg text-gray-800 dark:text-gray-100 font-hand">
